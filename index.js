...
const {
  ...
  const ownerNumber = ['263780325289']
...
async function connectToWA() {
    console.log("[🔰] SANCHO-XMD Connecting to WhatsApp ⏳️...");
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('[🔰] SANCHO-XMD connected to WhatsApp ✅');
            ...
            console.log('[🔰] Plugins installed successfully ✅');
                ...
                try {
                    ...
                    const upMessage = `╭─〔 *🤖 SANCHO-XMD BOT* 〕  
├─▸ *Ultra Super Fast Powerfull ⚠️*  
│     *World Best BOT SANCHO-XMD* 
╰─➤ *Your Smart WhatsApp Bot is Ready To use 🍁!*  

- *🖤 Thank You for Choosing SANCHO-XMD!* 

╭──〔 🔗 *Information* 〕  
├─ 🧩 *Prefix:* = ${prefix}
├─ 📢 *Join Channel:*  
│    https://whatsapp.com/channel/0029VbBE7xbFCCoTEjmgV73v 
├─ 🌟 *Star the Repo:*  
│    https://github.com/sanchotech/SANCHO-XMD-
╰─🚀 *Powered by SANCHOTECH*`;
